...
// HttpOnly cookie. On state-changing requests (POST/PUT/PATCH/DELETE),
// require the body to carry the same value as `csrf` (or the
// X-CSRF-Token header for JSON/XHR clients).
//
