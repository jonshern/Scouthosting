...
// New categories fall back to "primary" rather than picking randomly,
// so the dashboard doesn't shuffle colours when a leader adds a category.
const CATEGORY_COLORS = {
  meeting: "sky",
  campout: "accent",
  service: "teal",
  "court-of-honor": "raspberry",
  ceremony: "raspberry",
  training: "butter",
  fundraiser: "ember",
  trip: "plum",
...
export function categoryColor(category) {
  ...
  return CATEGORY_COLORS[key] || "primary";
}
