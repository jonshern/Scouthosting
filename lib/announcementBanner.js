...
function bannerHtml(announcement) {
  ...
  const previewBody = announcement.body
    ...
    .slice(0, 2)
    .join(" ");
  return `<aside class="site-banner" role="status" style="background:linear-gradient(135deg,var(--primary,#0e3320),var(--accent,#c8e94a));color:#fff;padding:.65rem 1rem;text-align:center;font-size:.92rem;border-bottom:1.5px solid #0d130d">
