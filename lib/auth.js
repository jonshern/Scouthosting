...
// production we set COOKIE_DOMAIN=.scouthosting.com so a session set on
// the apex (e.g. after Google OAuth callback) is also valid on every
// org subdomain. In dev, set this if you want the same behavior across
// *.localhost — browser support varies.
const cookieDomain = (process.env.COOKIE_DOMAIN || "").trim() || undefined;

export const lucia = new Lucia(adapter, {
  sessionCookie: {
    name: "scouthosting_session",
    expires: false,
    attributes: {
